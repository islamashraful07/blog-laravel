            ...
            <div class="col-lg-6">
                <article class="hentry post post-standard has-post-thumbnail sticky">
                        ...
                        <div class="post-thumb">
                            ...
                            <div class="overlay"></div>
                            <a href="/post/{{$second_post->slug}}" class="link-image js-zoom-image">
                                <i class="seoicon-zoom"></i>
                            </a>
                            <a href="#" class="link-post">
                                <i class="seoicon-link-bold"></i>
            ...
            <div class="container">
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{$max_category_name->name}}</h4>
                    ...
                    @foreach ($max_category_posts as $max_category_post)
                        <div class="case-item-wrap">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{$max_category_post->featured}}" alt="{{$max_category_post->title}}">
                                    </div>
                                    <h6 class="case-item__title"><a href="/post/{{$max_category_post->slug}}">{{$max_category_post->title}}</a></h6>
                                </div>
                            </div>
                ...
                <div class="offers">
                    <div class="row">
                        ...
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{$second_max_category_name->name}}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    @foreach ($second_max_category_posts as $second_max_category_post)
                        <div class="case-item-wrap">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{$second_max_category_post->featured}}" alt="our case">
                                    </div>
                                    <h6 class="case-item__title"><a href="/post/{{$second_max_category_post->slug}}">{{$second_max_category_post->title}}</a></h6>
                                </div>
                            </div>
                ...
                <div class="offers">
                    <div class="row">
                        <div class="col-lg-8 col-md-12 col-sm-12 col-xs-12">
                            <div class="heading">
                                <h4 class="h1 heading-title">{{$third_max_category_name->name}}</h4>
                                <div class="heading-line">
                                    <span class="short-line"></span>
                                    <span class="long-line"></span>
                                </div>
                    ...
                    <div class="row">
                    @foreach ($third_max_category_posts as $third_max_category_post)
                        <div class="case-item-wrap">
                            <div class="col-lg-4 col-md-4 col-sm-6 col-xs-12">
                                <div class="case-item">
                                    <div class="case-item__thumb">
                                        <img src="{{$third_max_category_post->featured}}" alt="our case">
                                    </div>
                                    <h6 class="case-item__title"><a href="/post/{{$third_max_category_post->slug}}">{{$third_max_category_post->title}}</a></h6>
                                </div>
                            </div>
        ...
        <div class="row">
            <div class="form_search-wrap">
                   ...
                   <form action="" >
                    ...
                    <input  class="overlay_search-input" placeholder="Type and hit Enter..." type="text" name="search" id="search"   >
